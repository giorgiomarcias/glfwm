...
namespace glfwm {
    ...
    public:
         ...
         *    @note   Any Drawable object can be bound to any number of different windows. The id parameter can be used to locate resources associated
         *            to it, e.g. OpenGL buffer objects.
         */
