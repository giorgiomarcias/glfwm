...
namespace glfwm {
    ...
    /**
     *  @brief  The WindowGroup class represents a group of Windows which can be managed together to be drawn, and even moved to another thread.
     */
    class WindowGroup {
    ...
    private:
        ...
        /**
         *  @brief  The attachedWindows is a set of WindowIDs corresponding to the Window currently attached to this group.
         */
