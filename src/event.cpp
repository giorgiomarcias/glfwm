...
namespace glfwm {
     ...
     *  @param  wID The ID of the window, or AllWindowIDs for every Window, or WholeGroupWindowIDs for all the Windows of the target group.
     ...
     */
    WindowID Event::getWindowID() const {
        return windowID;
    }
     ...
     */
    int EventWindowPosition::getX() const {
        return xPos;
    }
     ...
     */
    int EventWindowPosition::getY() const {
        return yPos;
    }
     ...
     */
    EventWindowSize::EventWindowSize(const EventWindowSize &ews)
        : Event(ews), width(ews.width), height(ews.height) {}

    /**
     *  @brief  Returns the new width of this window size change event.
     *  @return The new width coordinate.
     */
    int EventWindowSize::getWidth() const {
        return width;
    }
     ...
     */
    int EventWindowSize::getHeight() const {
        return height;
    }
     ...
     */
    EventWindowFocus::EventWindowFocus(const WindowID id, const bool f) : Event(id, EventType::WINDOW_FOCUS), focus(f) {}
     ...
     */
    bool EventWindowFocus::hasFocus() const {
        return focus;
    }
     ...
     */
    EventWindowIconify::EventWindowIconify(const WindowID id, const bool i) : Event(id, EventType::WINDOW_ICONIFY), iconify(i) {}
     ...
     *  @return true if the window should be iconified, false if it should be restored.
     */
    bool EventWindowIconify::toIconify() const {
        return iconify;
    }
     ...
     *  @brief  Default constructor.
     */
    EventFrameBufferSize::EventFrameBufferSize() : Event(AllWindowIDs, EventType::FRAMEBUFFERSIZE), width(0), height(0) {}
     ...
     *  @return The new width coordinate.
     */
    int EventFrameBufferSize::getWidth() const {
        return width;
    }
     ...
     *  @return The new height coordinate.
     */
    int EventFrameBufferSize::getHeight() const {
        return height;
    }
     ...
     */
    char32_t EventChar::getCharacter() const {
        return character;
    }
     ...
     *  @brief  Default constructor.
     */
    EventCharMod::EventCharMod() : Event(AllWindowIDs, EventType::CHARMOD), character(0), modifierKeys(static_cast<ModifierKeyBaseType>(ModifierKeyType::MODIFIER_NONE)) {}
     ...
     */
    EventCharMod::EventCharMod(const WindowID id, const char32_t c, const ModifierKeyBaseType m) : Event(id, EventType::CHARMOD), character(c), modifierKeys(m) {}

    /**
     *  @brief  Copy constructor.
     *  @param  ec The EventChar to copy.
     */
    EventCharMod::EventCharMod(const EventCharMod &ecm) : Event(ecm), character(ecm.character), modifierKeys(ecm.modifierKeys) {}

    /**
     *  @brief  Returns the new Unicode codepoint of this input event.
     *  @return The new input character.
     */
    char32_t EventCharMod::getCharacter() const {
        return character;
    }
     ...
     */
    ModifierKeyBaseType EventCharMod::getModifierKeys() const {
        return modifierKeys;
    }
     ...
     */
    EventCursorEnter::EventCursorEnter(const WindowID id, const bool e) : Event(id, EventType::CURSOR_ENTER), enter(e) {}
     ...
     */
    bool EventCursorEnter::isEntering() const {
        return enter;
    }
     ...
     */
    EventCursorPosition::EventCursorPosition(const EventCursorPosition &ecp) : Event(ecp), xPos(ecp.xPos), yPos(ecp.yPos) {}

    /**
     *  @brief  Returns the new x coordinate for this cursor position change event.
     *  @return The new x coordinate.
     */
    double EventCursorPosition::getX() const {
        return xPos;
    }
     ...
     *  @return The new y coordinate.
     */
    double EventCursorPosition::getY() const {
        return yPos;
    }
     ...
     */
    const std::list<std::string> & EventDrop::getPaths() const {
        return paths;
    }
     ...
     *  @brief  Default constructor.
     */
    EventKey::EventKey() : Event(AllWindowIDs, EventType::KEY), key(KeyType::KEY_UNKNOWN), scancode(0)
                         , action(ActionType::NONE), modifierKeys(static_cast<ModifierKeyBaseType>(ModifierKeyType::MODIFIER_NONE)) {}
     ...
     *  @param  m The new modifier keys (as a bit set of ModifierKeyType values).
     */
    EventKey::EventKey(const WindowID id, const KeyType k, const char32_t s, const ActionType a, const ModifierKeyBaseType m)
     ...
     */
    EventKey::EventKey(const EventKey &ek) : Event(ek), key(ek.key), scancode(ek.scancode), action(ek.action), modifierKeys(ek.modifierKeys) {}

    /**
     *  @brief  Returns the key identifier for this key event.
     *  @return The key identifier.
     */
    KeyType EventKey::getKey() const {
        return key;
    }
     ...
     */
    char32_t EventKey::getScancode() const {
        return scancode;
    }
     ...
     */
    ActionType EventKey::getAction() const {
        return action;
    }
     ...
     *  @return The input modifier keys (as a bit set of ModifierKeyType values).
     */
    ModifierKeyBaseType EventKey::getModifierKeys() const {
        return modifierKeys;
    }
     ...
     *  @brief  Default constructor.
     */
    EventMouseButton::EventMouseButton() : Event(AllWindowIDs, EventType::MOUSE_BUTTON), mouseButton(MouseButtonType::MOUSE_BUTTON_NONE), action(ActionType::NONE)
     ...
     *  @param  m The new modifier keys (as a bit set of ModifierKeyType values).
     */
    EventMouseButton::EventMouseButton(const WindowID id, const MouseButtonType mb, const ActionType a, const ModifierKeyBaseType m)
     ...
     */
    EventMouseButton::EventMouseButton(const EventMouseButton &emb) : Event(emb), mouseButton(emb.mouseButton),action(emb.action), modifierKeys(emb.modifierKeys) {}

    /**
     *  @brief  Returns the button identifier for this mouse button event.
     *  @return The button identifier.
     */
    MouseButtonType EventMouseButton::getMouseButton() const {
        return mouseButton;
    }
     ...
     */
    ActionType EventMouseButton::getAction() const {
        return action;
    }
     ...
     *  @return The input modifier keys (as a bit set of ModifierKeyType values).
     */
    ModifierKeyBaseType EventMouseButton::getModifierKeys() const {
        return modifierKeys;
    }
     ...
     */
    EventScroll::EventScroll(const WindowID id, const double x, const double y) : Event(id, EventType::SCROLL), xOffset(x), yOffset(y) {}
